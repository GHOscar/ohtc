...
const Header = () => {
  return (        
        ...
        <div className='w-full absolute px-8 flex flex-col items-center justify-center  h-full'>
            <h1 className='text-5xl sm:text-7xl font-bold text-white text-center'>Våra släpvagnar
            </h1>
