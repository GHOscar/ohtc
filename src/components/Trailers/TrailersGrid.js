...
const TrailersGrid = () => {
  return (
    <div className='max-w-[1200px] flex flex-col items-center justify-center w-full h-full mb-20'>
        <div className="pb-4 px-4 text-center mb-20">
        ...
        <div className="grid grid-cols-3 gap-8">
            <div className="filters pl-4">
                <div className="categories flex flex-col mb-8">
                    ...
                    <button className='border border-gray-300 rounded-sm w-[314px] pl-2 text-left py-2 my-2'>Släpvagnar</button>
                    <button className='border border-gray-300 rounded-sm w-[314px] pl-2 text-left py-2 my-2'>Hästtransporter</button>
                    <button className='border border-gray-300 rounded-sm w-[314px] pl-2 text-left py-2 my-2'>Däck</button>
                </div>
                <div className="brands flex flex-col mb-8">
                    <p className="font-bold">Varumärke</p>
                    <button className='border border-gray-300 rounded-sm w-[314px] pl-2 text-left py-2 my-2'>Hambaur</button>
                    <button className='border border-gray-300 rounded-sm w-[314px] pl-2 text-left py-2 my-2'>Debon</button>
                    <button className='border border-gray-300 rounded-sm w-[314px] pl-2 text-left py-2 my-2'>Tiki Trailer</button>
                    <button className='border border-gray-300 rounded-sm w-[314px] pl-2 text-left py-2 my-2'>Debon</button>
                </div>
                <div className="models mb-8">
                    <p className="font-bold">Modell</p>
                    <button className='border border-gray-300 rounded-sm w-[314px] pl-2 text-left py-2 my-2'>Tippsläp</button>
                    <button className='border border-gray-300 rounded-sm w-[314px] pl-2 text-left py-2 my-2'>Flaksläp</button>
                    <button className='border border-gray-300 rounded-sm w-[314px] pl-2 text-left py-2 my-2'>Skåpsläp</button>
                    <button className='border border-gray-300 rounded-sm w-[314px] pl-2 text-left py-2 my-2'>Maskinsläp</button>
                </div>
